...
# Import your custom GoLU class from models.alpha_golu
try:
...
def replace_relus_with_alpha_golu(model):
    """Recursively replaces standard ReLU activations with Adaptive Alpha-GoLU."""
...
def run_resnet_eval():
    ...
    # Swap out standard ReLU with Adaptive Alpha-GoLU
